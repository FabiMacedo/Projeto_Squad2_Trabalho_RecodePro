    ...
    <div class="container1">
        ...
        <div class="cursoconteudo">
            ...
            <div class="videoaula">
                ...
                <div class="video">
                    <iframe src="https://www.youtube.com/embed/JlMQCKM0w6M" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
        <div class="footer">
